...
const NavItem = ({ icon: Icon, label, href }) => (
    ...
    >
        <Icon size={20} />
        <span className="hidden md:inline font-pixel text-sm">{label}</span>
    </motion.a>
);
            ...
            <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-12">
                <div className="flex items-center justify-between h-24">
                    ...
                    <div className="flex-shrink-0 flex items-center gap-4">
                        <Terminal className="text-retro-primary w-8 h-8 md:w-10 md:h-10" />
                        <span className="font-pixel text-retro-primary text-lg md:text-xl">
                            PLAYER_1
                        </span>
                    </div>
                    ...
                    <div className="hidden lg:flex items-center gap-3 w-48">
                        <span className="text-sm font-pixel text-retro-secondary">HP</span>
                        <div className="h-6 flex-1 bg-gray-700 border-2 border-retro-text relative">
